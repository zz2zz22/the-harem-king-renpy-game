label intro:
    show bg school hall with fade
    "{i}Tôi, [p] là một học sinh trung học bình thường không có gì nổi bật, từ ngoại hình cho đến đầu óc đều gói gọn trong chữ {b}BÌNH THƯỜNG{/b}."
    ...
    pause 0.5
    show bg street shopping with circlewipe
    "{i}Như mọi ngày, sau khi trải qua những tiết học vô vị, tôi men theo cung đường quen thuộc để đến Trần Duy Hưng ngắm những \"tâm hồn\" mơn mởn."
    p "Hôm nay sao không thấy \"em\" nào vậy ta ?"
    "{i}Sau một hồi dò xét thì tôi đã phát hiện một cặp bưởi năm roi chuẩn giống Vĩnh Long, tôi lấy điện thoại ra để chuẩn bị lưu giữ tài liệu \"học tập\""
    "{i}Khi đang mải mê ngắm nhìn và tìm góc đẻ chụp ảnh cặp bưởi ấy, tôi đã vô tình va trúng thứ gì đó."
    "???" "Au..au..đau..quá"
    show aisha uniform akward with dissolve
    "{i}Trước mắt tôi là một cô bé tiểu học, cô bé thở gấp mồ hôi nhễ nhại như thể vừa chịc...à không như đang chạy trốn vậy."
    show aisha uniform rush
    "???" "Ahh! Em xin lỗi nhưng em đang bị đuổi theo, giúp em với!"
    "{i}Tôi nhìn về sau cô bé thì thấy 3 anh Minh Béo đang chạy hết tốc lực về phía tôi và cô bé..."
    menu:
    ...
    label choice_begin:
        "{i}Tôi nắm lấy tay cô bé và bắt đầu chạy thật nhanh đến khu phố mua sắm gần đó và lẫn vào dòng người tấp nập dần tiến vào một con hẻm vắng."
        show bg backalley with fade
        show aisha uniform akward with dissolve
        p "Hộc..Hộc...Anh nghĩ mình cắt đuôi được chúng rồi đấy!"
        p "Mà sao chúng lại đuổi theo em thế ?"
        "???" "Chúng đuổi theo em là vì thứ này.."
        "{i}Cô bé lấy một vật gì đó màu đen ở trong túi ra, đó là một chiếc điện thoại cũ hết sức bình thường."
        ...
        hide aisha uniform rush
        "{i}Đột nhiên cảm giác nhẹ tênh hai bên túi quần làm tôi xám cả mặt mà hét lớn."
        ...
        "{i}Cô bé bắt đầu bối rối và liên tục xin lỗi, thấy vậy tôi cũng không muốn quát thêm rồi cho con bé khóc lớn, như vậy chỉ khiến tôi rơi vào tình huống khó xử hơn."
        ...
        "{i}Tôi xoay người định bước đi thì..."
        show aisha uniform akward
        "???" "Anh ơi khoan đã!"
        p "Gì nữa đây ?"
        "???" "Anh hãy giữ nó dùng đi, xem như em đền lại cho anh."
        "{i}Cô bé dúi cái điện thoại của cô bé vào tay tôi."
        ...
        hide aisha uniform normal with moveoutright
        "{i}[a] sau khi nói xong thì chạy đi thật nhanh vào dòng người tấp nập ngoài phố."
        "{i}Tôi đứng nhìn chiếc điện thoại cũ trong tay thở dài, vừa kiểm tra chiếc điện thoại tôi vừa xoay người đi ra khỏi con hẻm."
        ...
        show truck hit:
            ...
            yalign 0.5
        with hpunch
        "{i}Khi đang mải mê xem xét chiếc điện thoại, tôi đã bị truck-kun hun một phát nhẹ nhàng và bất tỉnh ngay sau đó."
        hide truck hit
        hide bg backalley with slow_dissolve
        show black
        "{b}4 ngày sau...{b}"
        #Bắt đầu scene intro 2
        scene bg hospital room with slow_circleirisout
        "{i}Sau một thời gian, tôi dần lấy lại ý thức."
        show yuko uniform sad with dissolve
        "???" "Onii-chan! Anh tỉnh rồi!"
        "{i}Trước mắt tôi chính là Yuko-chan, cô em gái cùng cha khác mẹ của tôi."
        ...
        y "Thật may mắn anh chỉ bị gãy xương và một vài vết thương ngoài da. Do phần đầu bị chấn động dẫn đến hôn mê nhưng không có hậu quả gì nghiêm trọng."
        ...
        "{i}Sau khi Yuko đi tôi chợt để ý đến chiếc điện thoại để trên bàn gần đầu giường."
        ...
        "{i}Tôi thử khởi động chiếc máy, một âm thanh kì quái phát ra rồi chiếc điện thoại tắt ngúm."
        ...
        "{i}Cánh cửa phòng mở tung ra, một người phụ nữ trung niên chạy vào ôm chầm lấy tôi."
        ...
        p "Vân..."
        "{i}Đột nhiên trước mặt tôi xuất hiện một dòng chữ.{/i} {vspace=10}{space=40}{b}\"Bạn có muốn thôi miên mục tiêu trước mặt không ?\"{/b}"
        ...
        i "Haizz .. bó tay. Nói chung bố là thần tình yêu trú trong cái điện thoại mày đang cầm ấy."
        ...
        "{b}Một tháng sau...{b}"
        scene bg home room with fade
        p "Cuối cùng cũng được thả về. Haizzz ... Ở trong bệnh viện toàn mấy ông già làm luyện tập skill thôi miên không được bao nhiêu."
        i "Luyện thì cũng có tiền đâu cho mà luyện. Quên kiến thức à ?"
        p "Rồi rồi rồi muốn thôi miên thì phải trao đổi ngang hàng chứ gì ? Khổ lắm nói mãi."
        i "Cũng thuộc bài đó. Muốn thôi miên một người thì phải trả một cái giá, ở đây chính là tiền."
        i "Tùy theo mục tiêu mà số tiền sẽ khác nhau. Nếu có làm ấy ấy mà không kiểm soát được sinh nở thì cũng có thể dùng chức năng để giải quyết nhưng cũng phải trao đổi bằng tiền."
        i "Nếu muốn có gái thì lo cày tiền đi nhóc."
        p "Rồi rồi rồi. Mãi mới về được lãi nhãi miết."
        p "Rồi....Bây giờ làm gì đây ta ?"
